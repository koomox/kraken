...
const (
	...
	updateStoreFuncFormat = ""
...
func toUpdateStoreFuncFormat(funcName, compareFunc, subFunc, mapField string) (b string) {
...
func (m *MetadataTable)toUpdateStoreFuncFormat(funcName, compareFunc, mapFunc, structPrefix string) (b string) {
	...
	return toUpdateStoreFuncFormat(funcName, compareFunc, structPrefix + funcName, mapField)
}
